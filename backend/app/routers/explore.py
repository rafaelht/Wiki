...
async def explore_graph(
    ...
    depth: int = Query(3, ge=1, le=3, description="Profundidad de exploración (1-3)"),
    max_nodes: Optional[int] = Query(60, ge=10, le=200, description="Número máximo de nodos en el grafo")
) -> ExploreResponse:
    """
